...
#' @param national the category of the required stats, with FALSE being Club Stats and TRUE being National Team Stats
...
fb_player_season_stats <- function(player_url, stat_type, national = FALSE, time_pause = 3) {
  ...
  get_each_player_stats <- function(player_url, stat_type) {
    pb$tick()
