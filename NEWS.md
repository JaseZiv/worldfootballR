...
* `fotmob_get_league_ids()` failing due to addition of `localizedName` JSON element (0.6.2.3003) [#275](https://github.com/JaseZiv/worldfootballR/issues/275)
* `fotmob_get_match_details()` failing (again) due to change in `teamColors` JSON element (0.6.2.3003)
* `fotmob_get_match_players()` failing due to addition of nested JSON elements in `stat` element (0.6.2.3004) [#277](https://github.com/JaseZiv/worldfootballR/issues/277)
