...
#   test_df <- get_advanced_match_stats(match_url = test_urls, stat_type = "possession", team_or_player = "team", time_pause = 4)
...
#   expect_error(get_advanced_match_stats(match_url = "https://fbref.com/en/matches/c0996cac/Bordeaux-Nantes-August-21-2020-Ligue-1",
#                                         stat_type = "test", team_or_player = "player", time_pause = 4))
#
# })
#
#
...
#   test_df <- get_match_report(match_url = test_urls, time_pause = 4)
#   expect_type(test_df, "list")
#
#   # test that the correct number of columns returned
...
#   test_df <- get_match_results(country = c("ENG", "AUS"), gender = "F", season_end_year = 2021, tier="1st", time_pause = 4)
#   expect_type(test_df, "list")
#
...
#   testthat::skip_on_cran()
#   testthat::skip_if_offline()
#   test_urls <- get_match_urls(country = "AUS", gender = "F", season_end_year = 2020, tier="1st", time_pause = 4)
#   # test the functions returns the data
...
#
#   # test that incorrect url will error
#   expect_equal(length(get_match_urls(country = "BBB", gender = "M", season_end_year = 2021, tier="1st", time_pause = 4)), 0)
#
...
#   testthat::skip_if_offline()
#   # test the functions returns the data
#   expect_type(get_season_team_stats(country = "AUS", gender = "F", season_end_year = 2021, tier="1st", stat_type = "league_table_home_away", time_pause = 4), "list")
#   expect_type(get_season_team_stats(country = "AUS", gender = "F", season_end_year = 2021, tier="1st", stat_type = "standard", time_pause = 4), "list")
#   expect_type(get_season_team_stats(country = "ENG", gender = "M", season_end_year = 2021, tier="1st", stat_type = "keeper", time_pause = 4), "list")
#   expect_type(get_season_team_stats(country = "ENG", gender = "M", season_end_year = 2021, tier="1st", stat_type = "keeper_adv", time_pause = 4), "list")
#   expect_type(get_season_team_stats(country = "ENG", gender = "M", season_end_year = 2021, tier="1st", stat_type = "shooting", time_pause = 4), "list")
#   expect_type(get_season_team_stats(country = "ENG", gender = "M", season_end_year = 2021, tier="1st", stat_type = "passing", time_pause = 4), "list")
#   expect_type(get_season_team_stats(country = "ENG", gender = "M", season_end_year = 2021, tier="1st", stat_type = "passing_types", time_pause = 4), "list")
#   expect_type(get_season_team_stats(country = "ENG", gender = "M", season_end_year = 2021, tier="1st", stat_type = "goal_shot_creation", time_pause = 4), "list")
#   expect_type(get_season_team_stats(country = "ENG", gender = "M", season_end_year = 2021, tier="1st", stat_type = "defense", time_pause = 4), "list")
#   expect_type(get_season_team_stats(country = "ENG", gender = "M", season_end_year = 2021, tier="1st", stat_type = "possession", time_pause = 4), "list")
#   expect_type(get_season_team_stats(country = "ENG", gender = "M", season_end_year = 2021, tier="1st", stat_type = "playing_time", time_pause = 4), "list")
#   expect_type(get_season_team_stats(country = "ENG", gender = "M", season_end_year = 2021, tier="1st", stat_type = "misc", time_pause = 4), "list")
#
#   # test that multiple genders can be passed to the function
#   expect_type(get_season_team_stats(country = "AUS", gender = c("M", "F"), season_end_year = 2021, tier="1st", stat_type = "league_table", time_pause = 4), "list")
#
#   # test that incorrect URL will error
#   expect_equal(length(get_season_team_stats(country = "AUS", gender = "F", season_end_year = 2021, tier="1st", stat_type = "possession", time_pause = 4)), 0)
#
#   # test that an invalid stat_type will error
#   expect_error(get_season_team_stats(country = "AUS", gender = "F", season_end_year = 2021, tier="1st", stat_type = "test", time_pause = 4))
#
#   # test that MLS league table returns a new column for conference
#   mls_table <- get_season_team_stats(country = "USA", gender = "M", season_end_year = 2021, tier="1st", stat_type = "league_table", time_pause = 4)
...
#   testthat::skip_on_cran()
#   big5_team_shooting_multiple <- fb_big5_advanced_season_stats(season_end_year= c(2021:2022), stat_type= "shooting", team_or_player= "team", time_pause = 4)
...
#   shot_multiple_matches <- get_match_shooting(test_urls_multiple, time_pause = 4)
...
#   epl_2021_team_results <- get_team_match_results(team_url = epl_2021_team_urls[1:3], time_pause = 4)
