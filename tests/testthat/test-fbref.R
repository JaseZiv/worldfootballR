...
test_that("fb_advanced_match_stats() works", {
  ...
  test_df <- fb_advanced_match_stats(
    match_url = test_urls,
...
Sys.sleep(3)
test_that("fb_team_match_stats() works", {
  testthat::skip_on_cran()
  testthat::skip_if_offline()
...
test_that("fb_season_team_stats() works", {
  ...
  mls_table <- fb_season_team_stats(
    country = "USA",
    gender = "M",
    season_end_year = 2021,
    tier = "1st",
...
test_that("fb_big5_advanced_season_stats() works", {
  testthat::skip_on_cran()
  big5_team_shooting_multiple <- fb_big5_advanced_season_stats(
    season_end_year = c(2022:2023),
    stat_type = "shooting",
    team_or_player = "team",
    time_pause = 4
  )
...
test_that("fb_team_match_results() works", {
  ...
  epl_2021_team_urls <- fb_teams_urls(
    "https://fbref.com/en/comps/9/Premier-League-Stats",
    time_pause = 4
  )
  epl_2021_team_results <- fb_team_match_results(
    team_url = epl_2021_team_urls[1:3],
    time_pause = 4
  )
...
test_that("fb_player_match_logs() works", {
  testthat::skip_on_cran()
  ederson_summary <- fb_player_match_logs(
  ...
  messi_summary <- fb_player_match_logs(
    "https://fbref.com/en/players/d70ce98e/Lionel-Messi",
...
test_that("fb_team_player_stats() works", {
  testthat::skip_on_cran()
  fleetwood_standard_stats <- fb_team_player_stats(
    team_urls = "https://fbref.com/en/squads/d6a369a2/Fleetwood-Town-Stats",
    stat_type = 'standard',
    time_pause = 4
  )
  ...
  expect_error(fb_team_player_stats(
    team_urls = "https://fbref.com/en/squads/d6a369a2/Fleetwood-Town-Stats",
...
test_that("fb_team_match_log_stats() works", {
  testthat::skip_on_cran()
  liv_keeper_log <- fb_team_match_log_stats(
    team_url = "https://fbref.com/en/squads/822bd0ba/2022-2023/Liverpool-Stats",
    stat_type = 'keeper',
    time_pause = 4
  )
  ...
  # this should error because the stat type isn't available
  expect_error(fb_team_match_log_stats(
    team_url = "https://fbref.com/en/squads/d6a369a2/2022-2023/Fleetwood-Town-Stats",
    stat_type = 'keeper_adv',
    time_pause = 4
  ))
  # # this should error because the spelling of the stat type is incorrect
...
test_that("fb_team_goal_logs() works", {
  testthat::skip_on_cran()
  mc_goal_log <- fb_team_goal_logs(
    team_url = "https://fbref.com/en/squads/b8fd03ef/2021-2022/Manchester-City-Stats",
    time_pause = 4,
    for_or_against = "for"
  )
  granada_goal_log <- fb_team_goal_logs(
    team_url = "https://fbref.com/en/squads/a0435291/2022-2023/Granada-Stats",
    time_pause = 4,
    for_or_against = "for"
  )
...
test_that("fb_player_info() works", {
  testthat::skip_on_cran()
  jwp <- fb_player_info(
    player_url = "https://fbref.com/en/players/3515d404/James-Ward-Prowse"
  )
...
test_that("fb_player_goal_logs() works", {
  testthat::skip_on_cran()
  jwp_goal_log <- fb_player_goal_logs(
    player_url = "https://fbref.com/en/players/3515d404/James-Ward-Prowse",
    time_pause = 4,
    goals_or_assists = "goals"
  )
  gnahoua_goal_log <- fb_player_goal_logs(
    player_urls = "https://fbref.com/en/players/7440346f/Arthur-Gnahoua",
    time_pause = 4,
...
test_that("fb_league_stats() for players works", {
  testthat::skip_on_cran()
  testthat::skip_on_ci()
  expected_player_shooting_cols <- c(
    "Rk",
    "Player",
    "Player_Href",
    "Nation",
  ...
  expect_setequal(
    colnames(single_player_shooting_22),
    expected_player_shooting_cols
  )

  expected_player_misc_cols <- c(
    "Rk",
    "Player",
    "Player_Href",
    "Nation",
